...
#dfa = pd.read_excel(r'C:\Users\danwilde\Dropbox (Penn)\Dissertation\Factiva\final5.xlsx')
                ...
                for per in ppl:
                    ...
                    if len(ppl) == 1:
                        ...
                        # If either 0 or >1 orgs, do this:
                            ...
                            pos1a = re.findall(r'\b(?:(' + per + r')\W+(?:\w+\W+){0,' + str(mxld) + r'}?(' + l1 + r'))',
                                               stz4,
                                               re.IGNORECASE)
                            pos1b = re.findall(r'\b(?:(' + per + r')\W+(?:\w+\W+){0,' + str(mxld) + r'}?(' + l2 + r'))',
                                               stz4,
                                               re.IGNORECASE)
                            pos1c = re.findall(r'\b(?:(' + per + r')\W+(?:\w+\W+){0,' + str(mxld) + r'}?(' + l3 + r'))',
                                               stz4,
                                               re.IGNORECASE)
                            pos1d = re.findall(r'\b(?:(' + per + r')\W+(?:\w+\W+){0,' + str(mxld) + r'}?(' + l4 + r'))',
                                               stz4,
                                               re.IGNORECASE)
                            pos1e = re.findall(r'\b(?:(' + per + r')\W+(?:\w+\W+){0,' + str(mxld) + r'}?(' + l5 + r'))',
                                               stz4)
                            pos2a = re.findall(r'\b(?:(' + l1 + r')\W+(?:\w+\W+){0,' + str(mxld) + r'}?(' + per + r'))',
                                               stz4,
                                               re.IGNORECASE)
                            pos2b = re.findall(r'\b(?:(' + l2 + r')\W+(?:\w+\W+){0,' + str(mxld) + r'}?(' + per + r'))',
                                               stz4,
                                               re.IGNORECASE)
                            pos2c = re.findall(r'\b(?:(' + l3 + r')\W+(?:\w+\W+){0,' + str(mxld) + r'}?(' + per + r'))',
                                               stz4,
                                               re.IGNORECASE)
                            pos2d = re.findall(r'\b(?:(' + l4 + r')\W+(?:\w+\W+){0,' + str(mxld) + r'}?(' + per + r'))',
                                               stz4,
                                               re.IGNORECASE)
                            pos2e = re.findall(r'\b(?:(' + l5 + r')\W+(?:\w+\W+){0,' + str(mxld) + r'}?(' + per + r'))',
                                               stz4)
                            pos = pos1a + pos1b + pos1c + pos1d + pos1e + pos2a + pos2b + pos2c + pos2d + pos2e
                    ...
                    # Then by definition, must be >1 people
                        ...
                        pos1a = re.findall(r'\b(?:(' + per + r')\W+(?:\w+\W+){0,' + str(mxlds) + r'}?(' + l1 + r'))',
                                           stz4,
                                           re.IGNORECASE)
                        pos1b = re.findall(r'\b(?:(' + per + r')\W+(?:\w+\W+){0,' + str(mxlds) + r'}?(' + l2 + r'))',
                                           stz4,
                                           re.IGNORECASE)
                        pos1c = re.findall(r'\b(?:(' + per + r')\W+(?:\w+\W+){0,' + str(mxlds) + r'}?(' + l3 + r'))',
                                           stz4,
                                           re.IGNORECASE)
                        pos1d = re.findall(r'\b(?:(' + per + r')\W+(?:\w+\W+){0,' + str(mxlds) + r'}?(' + l4 + r'))',
                                           stz4,
                                           re.IGNORECASE)
                        pos1e = re.findall(r'\b(?:(' + per + r')\W+(?:\w+\W+){0,' + str(mxlds) + r'}?(' + l5 + r'))',
                                           stz4)
                        pos2a = re.findall(r'\b(?:(' + l1 + r')\W+(?:\w+\W+){0,' + str(mxlds) + r'}?(' + per + r'))',
                                           stz4,
                                           re.IGNORECASE)
                        pos2b = re.findall(r'\b(?:(' + l2 + r')\W+(?:\w+\W+){0,' + str(mxlds) + r'}?(' + per + r'))',
                                           stz4,
                                           re.IGNORECASE)
                        pos2c = re.findall(r'\b(?:(' + l3 + r')\W+(?:\w+\W+){0,' + str(mxlds) + r'}?(' + per + r'))',
                                           stz4,
                                           re.IGNORECASE)
                        pos2d = re.findall(r'\b(?:(' + l4 + r')\W+(?:\w+\W+){0,' + str(mxlds) + r'}?(' + per + r'))',
                                           stz4,
                                           re.IGNORECASE)
                        pos2e = re.findall(r'\b(?:(' + l5 + r')\W+(?:\w+\W+){0,' + str(mxlds) + r'}?(' + per + r'))',
                                           stz4)
                        pos = pos1a + pos1b + pos1c + pos1d + pos1e + pos2a + pos2b + pos2c + pos2d + pos2e
                            ...
                            for o in orgs:
                                ...
                                if c > 0 and len(b) > 0:
                                    ...
                                    # Org then whose then title.
                                        ...
                                        o3a = re.findall(r'\b(?:(' + o + r')\W+(?:\w+\W+){0,2}?(whose\s+(' + l1 + ')))',
                                                         stz4,
                                                         re.IGNORECASE)
                                        o3b = re.findall(r'\b(?:(' + o + r')\W+(?:\w+\W+){0,2}?(whose\s+(' + l2 + ')))',
                                                         stz4,
                                                         re.IGNORECASE)
                                        o3c = re.findall(r'\b(?:(' + o + r')\W+(?:\w+\W+){0,2}?(whose\s+(' + l3 + ')))',
                                                         stz4,
                                                         re.IGNORECASE)
                                        o3d = re.findall(r'\b(?:(' + o + r')\W+(?:\w+\W+){0,2}?(whose\s+(' + l4 + ')))',
                                                         stz4,
                                                         re.IGNORECASE)
                                        o3e = re.findall(r'\b(?:(' + o + r')\W+(?:\w+\W+){0,2}?(whose\s+(' + l5 + ')))',
                                                         stz4)
                                        ...
                                        if len(e) > 0:
                                            ...
                                            if len(gm) == 0:
                                                break
                                        # If not, check if org near title
                ...
                if len(s) > 0:
                                    ...
                                    if len(orgs) == 1:
                                        ...
                                        if len(k) > 0:
                                            ...
                                            df.loc[len(df.index)] = [n, person, last, role, firm, quote, qtype, qsaid,
                                                                     qpref,
                                                                     comment, AN, date, source, ment, stence]
                                        elif len(k) == 0:
                                            last = "NA"
                                            person = "NA"
                                            firm = org
                    ...
                    # If said equivalent but more than one person, do stuff:
                        ...
                        for per in prows:
                            ...
                            s1b = re.findall(r'(' + last + r').+(' + stext + 'r).+(' + start + r')(.+)(' + end + r')',
                                             stence,
                                             re.IGNORECASE)
                            s1 = s1a + s1b
                            s1 = ''.join(''.join(elems) for elems in s1)
